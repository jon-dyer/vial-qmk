...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_B] = LAYOUT_all( /* Base */
        KC_PRINT_SCREEN,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, KC_F12,   KC_DEL,           KC_MUTE,
        ...
        KC_LSFT,  KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, _______,  KC_END,
        KC_LCTL,  KC_LGUI, MO(WASDOWS) ,                   KC_SPC,                             KC_RALT, MO(WIN_FN),KC_RCTL,        KC_MPRV, KC_MPLY, KC_MNXT),

    [WASDOWS] = LAYOUT_all( /* Base */
    ...
    [WIN_FN] = LAYOUT_all( /* WASD/↑←↓→ */
        _______, KC_MYCM, _______, KC_WSCH, KC_WHOM, KC_MSEL, KC_MPLY, KC_MPRV, KC_MNXT, _______, _______, _______, _______, _______,           RGB_MOD,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_SPD, RGB_SPI, _______,           _______,
        _______, _______,TG(WASDOWS),_______, _______, _______, _______, _______, KC_INS,  DF(MAC_B),KC_PSCR,_______, _______, RGB_MOD,           _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [WASDOWS] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD) },
